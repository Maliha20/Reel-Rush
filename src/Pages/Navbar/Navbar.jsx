    ...
    <div className="absolute max-w-screen-xl z-10 bg-opacity-5 navbar bg-base-100 ">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            <Link to="/">Home</Link>
            <Link to="/login/movie">Movie</Link>
          </ul>
        </div>
      ...
      {user ? (
        <div>
          ...
          <button
            ...
            className="btn btn-ghost px-1 md:px-5 md:me-12 bg-yellow-500"
          >
            LogOut
          </button>
        </div>
          ...
          <Link to="/login">
            <button className="btn btn-ghost px-1 md:px-5 md:me-12 bg-yellow-500">
              Login
            </button>
          </Link>
